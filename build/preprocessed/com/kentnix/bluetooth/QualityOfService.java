...
/**
 * This class Contains states or behaviour of this application */
...
/**
 * stores current list of devices .
 * @param devices list to be stored
 */
     ...
     * @param dev device been discovered
     * @param devaddr Device addredd of device discovered
     */
    ...
    /**return device address of all device been discovered
    */
    public Vector getDevaddr() {
        return deviceaddr;
    }
    /**
     * stores address of current device list .
 * @param deviceaddr address list to be stored
 ...
 /**
     * removes address from current device list .
 * @param deviceaddr address list to be stored
     */
