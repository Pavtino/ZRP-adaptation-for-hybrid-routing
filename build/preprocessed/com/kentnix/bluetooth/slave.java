...
/**Contains implementation of bluetooth slave
 */
public class slave implements DiscoveryListener, Runnable {
    ...
    /***
     *Creates new bluetooth client and transfers data to another client based on
     * header.
     * @param from current local device address
     * @param head Header of packet being sent
     * @param toDev ToAdderess of device being sent
     * @param tomsg message to be sent
     * @param type type of message to be sent 1 for 1 hop distant device
     * 2 for multi hop
     *
.     */
...
/**
 * sends message typed at user interface to ToAddress
 *
 */
...
/**
 * replys path information to new device which query s for path info
 */
    ...
    /**
     * Is not my message the forward it
     */
...
/**
 * Search s for new device in neighbouring network to join scatternet
 */
...
/**
 * Search for neighbouring devices
 */
...
//            }
   ...
   */
    ...
    /**called when device search is completed
     */
    ...
    /**
     * stores new device which has scatternet service
     */
...
/**sends current device path info to all neighbouring device
 */
   ...
   /**Reports error in case remote device moved out of range and removes device from routing table
    */
...
/**Starts service search on remote devices
 */
